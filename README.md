...
조합/순차 회로 기초부터 RV32I CPU, AXI4-Lite 기반 SoC, UVM 검증 환경까지 약 4개월간의 학습 과정을 단계별로 담았습니다.

> 단순 실습 코드뿐 아니라 직렬 통신 IP 설계, 버스 연동, 검증 환경 구축 등 실무에 가까운 작업을 포함하고 있습니다.
> 대표 프로젝트의 상세 설계 내용은 [⭐ 대표 프로젝트](#-대표-프로젝트) 항목의 개별 README를 참고해 주세요.

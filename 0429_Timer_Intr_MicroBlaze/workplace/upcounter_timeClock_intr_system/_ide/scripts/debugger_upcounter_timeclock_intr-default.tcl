...
# Path of this script: D:\system_verilog\0429_Timer_Intr_MicroBlaze\workplace\upcounter_timeClock_intr_system\_ide\scripts\debugger_upcounter_timeclock_intr-default.tcl
# 
# 
# Usage with xsct:
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow D:/system_verilog/0429_Timer_Intr_MicroBlaze/workplace/upcounter_timeClock_intr/Debug/upcounter_timeClock_intr.elf
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
con
